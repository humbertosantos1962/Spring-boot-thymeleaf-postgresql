...
public class PessoaController{
	...
	/*Método para download nunca tem resposta é sempre void*/
	...
	public void baixarcurriculo(@PathVariable("idpessoa") Long idpessoa , HttpServletResponse response) throws IOException {
		...
		if(pessoa.getCurriculo() != null) {
			...
			/*Tipo de arquivo para download ou pode ser genérica  application/octet-stream*/
	...
	public void  imprimePdf(@RequestParam("nomepesquisa") String nomepesquisa,
		...
		/*Chame o serviço que faz a geração de relatório */
